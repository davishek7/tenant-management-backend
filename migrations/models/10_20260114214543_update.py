...
CREATE INDEX IF NOT EXISTS "idx_adjustments_tenant__c74740" ON "adjustments" ("tenant_id");
CREATE INDEX IF NOT EXISTS "idx_adjustments_user_id_0f18cb" ON "adjustments" ("user_id");
COMMENT ON COLUMN "adjustments"."reason" IS 'LATE_FEE: LATE_FEE\nDISCOUNT: DISCOUNT\nWAIVER: WAIVER\nCORRECTION: CORRECTION\nOTHER: OTHER';"""
