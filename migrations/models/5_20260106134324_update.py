...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        DROP INDEX IF EXISTS "uid_tenants_unit_id_c97be8";
        ALTER TABLE "tenants" DROP CONSTRAINT IF EXISTS "fk_tenants_units_4930a13f";
        ALTER TABLE "tenants" ADD "user_id" UUID NOT NULL;
        ALTER TABLE "tenants" ADD "property_id" UUID NOT NULL;
        ALTER TABLE "users" ADD "password" VARCHAR(255);
        ALTER TABLE "users" ALTER COLUMN "email" SET NOT NULL;
        ALTER TABLE "tenants" ADD CONSTRAINT "fk_tenants_units_4930a13f" FOREIGN KEY ("unit_id") REFERENCES "units" ("id") ON DELETE CASCADE;
        ALTER TABLE "tenants" ADD CONSTRAINT "fk_tenants_users_0039fabe" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON DELETE CASCADE;
        ALTER TABLE "tenants" ADD CONSTRAINT "fk_tenants_properti_838a227d" FOREIGN KEY ("property_id") REFERENCES "properties" ("id") ON DELETE CASCADE;
        CREATE INDEX IF NOT EXISTS "idx_tenants_user_id_7aff92" ON "tenants" ("user_id");
        CREATE INDEX IF NOT EXISTS "idx_tenants_propert_935510" ON "tenants" ("property_id");
        CREATE INDEX IF NOT EXISTS "idx_tenants_unit_id_c97be8" ON "tenants" ("unit_id");
        CREATE UNIQUE INDEX IF NOT EXISTS "uid_users_email_133a6f" ON "users" ("email");"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        DROP INDEX IF EXISTS "idx_tenants_unit_id_c97be8";
        DROP INDEX IF EXISTS "idx_tenants_propert_935510";
        DROP INDEX IF EXISTS "idx_tenants_user_id_7aff92";
        ALTER TABLE "tenants" DROP CONSTRAINT IF EXISTS "fk_tenants_properti_838a227d";
        ...
        ALTER TABLE "tenants" ADD CONSTRAINT "fk_tenants_units_4930a13f" FOREIGN KEY ("unit_id") REFERENCES "units" ("id") ON DELETE CASCADE;
        CREATE UNIQUE INDEX IF NOT EXISTS "uid_tenants_unit_id_c97be8" ON "tenants" ("unit_id");"""
